...
class DashboardComponent extends Component {
    ...
    render() {
        ...
        let firstSprintStart = moment(Config.sprints[0].start, "YYYY-MM-DD");
        let dateRange = {min: firstSprintStart, max: moment()};

        let sprints = map(Config.sprints, function(sprint) {
        ...
        return (
            <div>
                ...
                <Segment>
                    <Card.Group>
                        {Config.customers.map(function(customer, index) {
