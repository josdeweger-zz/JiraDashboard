...
ENV REACT_APP_JIRA_NODE_SERVER_SETTINGS_URL "http://rhm-d-dock01.boolhosting.tld:3001/settings"
ENV REACT_APP_JIRA_API_CUSTOMER_STATUS_URL "http://rhm-d-dock01.boolhosting.tld:3002/customer/status"
